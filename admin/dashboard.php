...
$totalFacilitator = $conn->query("SELECT COUNT(*) as total FROM Facilitator")->fetch_assoc()['total'] ?? 0;
      ...
      <div class="container-fluid py-4">
        <div class="row g-3 mb-4">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card shadow-sm text-white" style="background: linear-gradient(135deg, #007bff, #28a745);">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card shadow-sm text-white" style="background: linear-gradient(135deg, #007bff, #28a745);">
              <div class="card-body d-flex align-items-center">
                <span class="material-icons me-3" style="font-size:40px;">event_note</span>
                <div>
                  <h6>Total Facilitator</h6>
                  <h3><?= $totalFacilitator ?></h3>
                </div>
              </div>
            </div>
          </div>
